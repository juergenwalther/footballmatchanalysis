tracktics_read_player_stats <- function(file, player_first_name, player_last_name = NA) {
  ...
  ret <- c(df_player$Time.on.Pitch..mins.,
           ...
           df_player$Progressive.Sprints, df_player$Sprints.1st.Half, df_player$Progressive.Sprints.2nd.Half,
  ...
  names(ret) <- c("Gespielte Minuten", "Distanz Spiel (in km)","Distanz 1.HZ (in km)","Distanz 2.HZ (in km)",
                  ...
                  "Anteil progressiver Sprints an Sprints (in %)", "Anteil progressiver an Sprints 1.HZ (in %)", "Anteil progressiver an Sprints 2.HZ (in %)",
