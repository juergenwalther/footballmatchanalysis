...
png(file = paste0(outfolder, "/", spiel, "_Zusammenfassung_Statistiken.png"), height = 840, width = 400)
...
png(file = paste0(path, "/Statistik/Zusammenfassung/", Sys.Date(), "_Statistiken_kombiniert.png"), height = 840, width = 300 + length(stat_files) * 80)
