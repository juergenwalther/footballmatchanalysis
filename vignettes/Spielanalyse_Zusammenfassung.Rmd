...
# Save table
xlsx::write.xlsx(x = st_load, file = paste0(path, "/Statistik/Zusammenfassung/Statistiken_kombiniert.xlsx"), row.names = FALSE)

df_st_load <- as.data.frame(st_load)
df_st_load <- df_st_load %>% dplyr::mutate_if(is.list, as.character)

png(file = paste0(path, "/Statistik/Zusammenfassung/Statistiken_kombiniert.png"), height = 650, width = 800)
