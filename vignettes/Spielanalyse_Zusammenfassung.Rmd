...
plot_won_space(pass = pass_space_won_tot, outpath = outfolder_pass, filename = "Raumgewinn_vs_Anzahl_Paesse")
plot_won_space(pass = pass_space_won_tot, histogram = TRUE, outpath = outfolder_pass, filename = "Histogramm_Raumgewinn")
...
png(file = paste0(outfolder, "/", spiel, "_Zusammenfassung_Statistiken.png"), height = 750, width = 400)
