...
summary_table <- summary_table(pass = pass_tot, shots = shots_tot, shots_opp = shots_opp_tot, pass_areas = pass_areas_tot, pass_space_won_tot = pass_space_won_tot, ecken = ecken, ecken_gegner = ecken_gegner)
...
save(spiel, 
     ...
     ecken,
     ecken_gegner,
     summary_table, file = paste0(path, "/Statistik/", spiel, ".Rdata"))
...
png(file = paste0(outfolder, "/", spiel, "_Zusammenfassung_Statistiken.png"), height = 800, width = 400)
