...
plot_balls_wonlost_individual <- TRUE
...
# Plot together
plot_all_sections(list_dfs = shots, n_sections = n_sections, title = "Schüsse WFV", outpath = outfolder_shots, filename = paste0("schuesse_combined"), parameter = "shots", size_points = 2.5)
plot_all_sections(list_dfs = shots_opp, n_sections = n_sections, title = "Schüsse Gegner", outpath = outfolder_shots, filename = paste0("schuesse_gegner_combined"), parameter = "shots", size_points = 2.5)
