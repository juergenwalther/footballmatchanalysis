...
plot_all_sections(list_dfs = shots, n_sections = n_sections, title = "Ballgewinne", subtitle = paste0("Position der Ballgewinne in den Spielabschnitten "), outpath = outfolder_shots, filename = paste0("shots_combined"))
