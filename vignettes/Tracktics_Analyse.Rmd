...
colnames(data_single_tt) <- c("Tracktics Paramter", "Durchschnitt", colnames(data_single))
...
# Plot result
png(file = paste0(full_path, "/Einzelspieler/", first_name,"_",last_name, "_", Sys.Date(),".png"), height = 540, width = 340 + (ncol(df_data_single_tt)-1) * 75)
